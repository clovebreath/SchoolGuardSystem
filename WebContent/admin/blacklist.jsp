		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<form class="navbar-form navbar-left" role="search" method="GET" action="blacklist.jsp">
      ...
      <tbody>
       ...
       if(request.getParameter("id")!=null){
    	 ...
    	 //**连接数据库**
			try{
			    ...
			    String user = "root";
			    String pwd = "123456";
			    String sql="SELECT id,name,pic,wname,note,phone FROM schoolsys.blacklist left join schoolsys.worker on contactid=wid where id=\"" + request.getParameter("id")+ "\"";
       ...
       <tr>
			...
			try{
			    ...
			    String user = "root";
			    String pwd = "123456";
			    String sql="SELECT id,name,pic,wname,note,phone FROM schoolsys.blacklist left join schoolsys.worker on contactid=wid";
			 //   String sql = "SELECT id,name,identity,status,sname,wname,time FROM schoolsys.record left join worker on record.tid=worker.wid left join student on record.sid=student.sid ORDER BY id desc";
			    Class.forName("com.mysql.jdbc.Driver");
			    Connection conn = DriverManager.getConnection(connectString, user, pwd);
